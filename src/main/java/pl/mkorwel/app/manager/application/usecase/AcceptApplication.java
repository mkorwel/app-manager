...
@Component
public class AcceptApplication implements BaseUserCase<Result<Void>, Long> {

	private Logger logger = LoggerFactory.getLogger(AcceptApplication.class);
	
	private ApplicationRepository applicationRepository;

	@Autowired
	public AcceptApplication(ApplicationRepository applicationRepository) {
